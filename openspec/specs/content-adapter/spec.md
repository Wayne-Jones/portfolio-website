...
Define a CMS-agnostic content abstraction layer so that components consume content through a unified interface, with Ghost as the initial adapter implementation.
